...
import com.axinom.drm.quickstart.player.DashRendererBuilder;
import com.axinom.drm.quickstart.player.DemoPlayer;
import com.axinom.drm.quickstart.player.DemoPlayer.RendererBuilder;
import com.axinom.drm.quickstart.player.ExtractorRendererBuilder;
import com.axinom.drm.quickstart.player.HlsRendererBuilder;
import com.axinom.drm.quickstart.player.SmoothStreamingRendererBuilder;
    ...
    switch (contentType) {
      case Util.TYPE_SS:
        return new SmoothStreamingRendererBuilder(this, userAgent, contentUri.toString(),
            new SmoothStreamingTestMediaDrmCallback("https://drm-playready-licensing.axtest.net/AcquireLicense", mLicenseToken));
      case Util.TYPE_DASH:
        return new DashRendererBuilder(this, userAgent, contentUri.toString(),
            new WidevineTestMediaDrmCallback("https://drm-widevine-licensing.axtest.net/AcquireLicense", mLicenseToken));
      case Util.TYPE_HLS:
